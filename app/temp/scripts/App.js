...
function () {
  ...
  _createClass(StickyHeader, [{
    ...
    key: "creatSectionWaypoint",
    value: function creatSectionWaypoint() {
      var that = this;
...
function () {
  ...
  _createClass(Modal, [{
    ...
    value: function events() {
      ...
      this.openModalButton.click(this.openModal.bind(this)); //cliking the x close modal button
